flectra.define('mrp_record_barcode_mode', function (require) {
"use strict";
...
var MrpBarcodeMode = Widget.extend({
    ...
    display_data: function(){
        ...
        this._rpc({
            ...
            .then(function (mrp_record){
                ...
                self.$(".o_mrp_record_barcode_item").html(QWeb.render("MrpRecordBarcodeItem", {mrp_record: mrp_record[0]}));
            });
    ...
    display_info: function(mrp_record){
        ...
        if (self.mrp_record.code) {
            filter = [['code', '=', self.mrp_record.code],
        ...
        this._rpc({
               ...
               self.$(".o_mrp_record_barcode_mode_info").html(QWeb.render("MrpRecordBarcodeModeInfo", {workorder: workorder_data}));
        });
    },
